        ...
        <div className="flex items-center justify-center gap-3 relative">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button variant="ghost" size="icon" className="absolute -top-2 -left-2 rtl:right-auto rtl:-right-2 rtl:left-auto">
                    <Settings className="h-6 w-6 text-muted-foreground" />
                    <span className="sr-only">فتح إعدادات الاتصال</span>
                </Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    أدخل هنا تفاصيل الاتصال بقاعدة بيانات SQL Server.
                  </DialogDescription>
                </DialogHeader>
